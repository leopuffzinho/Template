        ...
        <Container maxWidth="xl">
            <Toolbar disableGutters>
              <Grid container sx={{ alignItems: "center"}}>
                ...
                <Grid item xs={3} md={3} sx={{ display: { lg: "none", xs: "block", md: "block"}}}>
                <IconButton 
                size="large"
              ...
              >
                ...
                <Box>
                  ...
                  <Button variant="contained" href="/dashboard/produtos">Produtos</Button>
                </Box>
                </Grid>

                <Grid item lg={2} xs={3} md={4} sx={{ textAlign: "right" }}>
                  <Tooltip title="Perfil" > 
                    <IconButton onClick={handleOpenUserMenu}>
                      <Avatar alt="Leonardo Alves" src="" />
                    </IconButton>
                  </Tooltip> 
